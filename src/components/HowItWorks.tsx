...
import { Plane, Upload, Eye, ArrowRight } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: 'Deploy our custom VTOL drone to capture high-resolution multispectral imagery across your target agricultural area.',
    ...
    },
    {
      ...
      description: 'Seamlessly upload captured data to our cloud-based analytics platform for real-time processing and analysis.',
    ...
    },
    {
      icon: Eye,
      title: 'Analyze & Act',
      description: 'Access actionable crop insights through our intuitive dashboard with geo-tagged recommendations and alerts.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            ...
            <div className="space-y-2">
              <div className="text-2xl font-bold text-blue-600">2hours</div>
